...
import { initDuckDB, loadSamples } from './data.js?v=44';
import { setupEventListeners } from './ui.js?v=44';
import { goBackOneLevel, clearAllFilters, navigateToFilterLevel } from './sunburst.js?v=44';
