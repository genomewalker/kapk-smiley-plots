...
import { applyFilters, exportData } from './data.js?v=36';
import { cleanName, getStatus, pct, fmt, convertResults } from './utils.js?v=36';
...
window.searchSelectTaxon = function(taxonName, level) {
    ...
    import('./compare.js?v=36').then(({ trackTaxonAcrossSamples }) => {
...
export function setupEventListeners() {
    ...
    document.getElementById('compare-btn').addEventListener('click', () => {
        import('./compare.js?v=36').then(({ openComparePanel }) => {
            openComparePanel();
        });
    });
