...
import { applyFilters, exportData } from './data.js?v=41';
import { cleanName, getStatus, pct, fmt, convertResults } from './utils.js?v=41';
...
window.searchSelectTaxon = function(taxonName, level) {
    ...
    import('./compare.js?v=41').then(({ trackTaxonAcrossSamples }) => {
...
export function setupEventListeners() {
    ...
    document.getElementById('compare-btn').addEventListener('click', () => {
        import('./compare.js?v=41').then(({ openComparePanel }) => {
            openComparePanel();
        });
    });
